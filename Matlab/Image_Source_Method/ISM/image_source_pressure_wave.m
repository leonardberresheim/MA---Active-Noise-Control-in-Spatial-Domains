...
%   [in_p, out_p_abs] = IMAGE_SOURCE_PRESSURE_WAVE(S,R,L,t,spacing,c,f,Q,rho,order,alpha,geogebra) 
%   Eingabe 
...
% 
function [in_p, out_p_abs] = image_source_pressure_wave(S,R,L,t,spacing,c,f,Q,rho,order,alpha,geogebra)
    ...
    [in_p, out_p, out_p_abs] = pressure_wave(M, R, f, t, c, Q, rho, beta, spacing);
