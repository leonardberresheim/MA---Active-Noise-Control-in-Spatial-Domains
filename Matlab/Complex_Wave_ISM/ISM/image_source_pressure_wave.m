...
%   [out_p] = IMAGE_SOURCE_PRESSURE_WAVE(S,R,L,t,spacing,c,f,mag,Q,rho,order,alpha,geogebra) 
%   Eingabe 
...
% 
function [out_p] = image_source_pressure_wave(S,R,L,t,spacing,c,f,mag,Q,rho,order,alpha,geogebra)
    ...
    out_p_abs = pressure_wave(M, R, f, mag, t, c, Q, rho, beta, spacing);
