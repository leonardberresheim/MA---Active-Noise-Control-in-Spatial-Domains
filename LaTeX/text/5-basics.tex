...
\begin{figure}[H]
    ...
    \caption{Image source method with reflections for the x-dimension\cite{Fu2016}} where the black star is the receiver, the black point is the source and the circle are the sources reflection for a certain order.
    \label{fig:imsX}
\end{figure}
